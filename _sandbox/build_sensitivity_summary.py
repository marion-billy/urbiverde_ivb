...
Reads the reference run (data/outputs/) and every perturbed run under data/sensitivity/<tag>/,
...
data/sensitivity/sensitivity_summary.csv. Reproducible: re-run after any new perturbed batch.
...
SENS = os.path.join(ROOT, "data", "sensitivity")
